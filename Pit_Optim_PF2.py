        ...
        if st.session_state.results_ready:
            ...
            with tab1:
                ...
                with metric_cols[2]:
                    ...
                    ore_blocks = sum(1 for block in st.session_state.optimal_pit if block['grade'] > cutoff_grade/100 if st.session_state.deposit_type == "base_metals" else block['grade'] > cutoff_grade)
